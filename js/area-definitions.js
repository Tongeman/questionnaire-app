...
const REPORT_CLOSING = "You've just done something most business owners never do: you've looked honestly at all nine areas that determine whether a business grows or stays stuck.\n\nThat clarity is valuable. But clarity alone doesn't fix anything.\n\nOver the next few days, I'm going to share some ideas with you — not a sales pitch, just the thinking behind how these nine areas connect and why fixing them in isolation rarely works.\n\n**Tomorrow's email**: \"The one area that's probably not the real problem (even if it scored lowest)\"\n\nIt might change how you think about your scorecard results.\n\nSpeak soon,\n\n**Lee Duncan**\nAuthor, *Double Your Business* (FT Publishing)";
